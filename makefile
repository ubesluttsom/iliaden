...
CHECK  = tekst/00-forord.md tekst/01-sang.md tekst/02-sang.md tekst/03-sang.md tekst/04-sang.md tekst/16-sang.md
...
check: $(CHECK)
	sed -i '' '/^#/d' ordliste/ordliste.utf-8.add # sletter alle linjer som begynner med skigard
